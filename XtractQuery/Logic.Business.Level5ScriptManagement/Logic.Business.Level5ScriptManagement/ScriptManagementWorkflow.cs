    ...
    : IScriptManagementWorkflow
{
    ...
    private void PrintHelp()
    {
        ...
        Console.WriteLine("    Valid types are: xq32, xseq, xscr, gss1, gsd1, gds");
        Console.WriteLine("    The type is automatically detected when extracting; This option will not have any effect on operation 'e' and 'd'");
        ...
        Console.WriteLine("    This option is automatically detected when extracting; This option will not have any effect on operation 'e' and 'd'");
        Console.WriteLine("  -ns, --no-syntax\t[Optional] If the file should emit high-level syntax");
        Console.WriteLine("    This option will not have any effect on operation 'c'");
