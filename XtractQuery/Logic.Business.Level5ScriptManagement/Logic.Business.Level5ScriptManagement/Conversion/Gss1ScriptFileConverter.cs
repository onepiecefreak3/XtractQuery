...
internal class Gss1ScriptFileConverter(IMethodNameMapper methodNameMapper, ILevel5SyntaxFactory syntaxFactory)
    : IGss1ScriptFileConverter
{
    ...
    private GotoExpressionSyntax CreateGotoExpression(ScriptInstruction instruction, Gss1ScriptFile script)
    {
    ...
    private CommaSeparatedSyntaxList<ValueExpressionSyntax>? CreateGotoLabelList(ScriptInstruction instruction, Gss1ScriptFile script)
    {
    ...
    private CommaSeparatedSyntaxList<ExpressionSyntax>? CreateMethodInvocationParameterList(ScriptInstruction instruction, Gss1ScriptFile script)
    {
        int argumentCount = instruction.ArgumentCount;
        int argumentIndex = instruction.ArgumentIndex;
