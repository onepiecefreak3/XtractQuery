...
internal partial class Gss1CodeUnitConverter(IMethodNameMapper methodNameMapper) : IGss1CodeUnitConverter
{
    public Gss1ScriptFile CreateScriptFile(CodeUnitSyntax tree)
    {
        var result = new Gss1ScriptFile
        {
    ...
    private void AddFunctions(Gss1ScriptFile result, IReadOnlyList<MethodDeclarationSyntax> methods)
    {
    ...
    private void AddPostfixUnaryStatement(Gss1ScriptFile result, PostfixUnaryStatementSyntax postfixUnaryStatement)
    {
        int instructionType;
    ...
    private void AddVariablePostfixUnaryStatement(Gss1ScriptFile result, int instructionType, int variableSlot)
    {
        AddInstruction(result, result.Arguments.Count, 0, instructionType, variableSlot);
    }

    private void AddArrayPostfixUnaryVariableStatement(Gss1ScriptFile result, IReadOnlyList<ArrayIndexerExpressionSyntax> indexer, int instructionType, int variableSlot)
    {
    ...
    private void AddIfGotoStatement(Gss1ScriptFile result, IfGotoStatementSyntax ifGotoStatement)
    {
    ...
    private void AddGotoStatement(Gss1ScriptFile result, GotoStatementSyntax gotoStatement)
    {
        var argumentStartIndex = (short)result.Arguments.Count;
    ...
    private void AddJump(Gss1ScriptFile result, GotoLabelStatementSyntax gotoLabelStatement)
    {
    ...
    private void AddYieldStatement(Gss1ScriptFile result)
    {
        AddInstruction(result, (short)result.Arguments.Count, 0, 10, 1001);
    }

    private void AddReturnStatement(Gss1ScriptFile result, ReturnStatementSyntax returnStatement)
    {
        var argumentStartIndex = (short)result.Arguments.Count;
    ...
    private void AddExitStatement(Gss1ScriptFile result)
    {
        AddInstruction(result, (short)result.Arguments.Count, 0, 12, 1001);
    }

    private void AddAssignmentStatement(Gss1ScriptFile result, AssignmentStatementSyntax assignmentStatement)
    {
    ...
    private void AddExpression(Gss1ScriptFile result, ExpressionSyntax expression, out int instructionType)
    {
        instructionType = -1;
    ...
    private void AddInstruction(Gss1ScriptFile result, int argumentIndex, int argumentCount, int instructionType, int returnParameter)
    {
    ...
    private void AddArgument(Gss1ScriptFile result, VariableExpressionSyntax variable, ValueMetadataParametersSyntax? metadata)
    {
    ...
    private void AddArgument(Gss1ScriptFile result, UnaryExpressionSyntax unary, ValueMetadataParametersSyntax? metadata)
    {
    ...
    private void AddArgument(Gss1ScriptFile result, LiteralExpressionSyntax literal, ValueMetadataParametersSyntax? metadata)
    {
    ...
    private void AddArgument(Gss1ScriptFile result, ScriptArgumentType type, object value, ValueMetadataParametersSyntax? metadata)
    {
    ...
    private void AddArgument(Gss1ScriptFile result, ScriptArgumentType type, object value, int rawArgumentType = -1)
    {
