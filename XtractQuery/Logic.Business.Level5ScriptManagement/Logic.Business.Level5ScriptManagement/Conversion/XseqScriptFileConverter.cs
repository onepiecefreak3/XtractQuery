...
internal class XseqScriptFileConverter : IXseqScriptFileConverter
{
    private readonly IMethodNameMapper _methodNameMapper;
    private readonly ILevel5SyntaxFactory _syntaxFactory;

    public XseqScriptFileConverter(IMethodNameMapper methodNameMapper, ILevel5SyntaxFactory syntaxFactory)
    {
    ...
    private IReadOnlyList<MethodDeclarationSyntax> CreateMethodDeclarations(ScriptFile script)
    {
    ...
    private IReadOnlyList<StatementSyntax>? CreateStatements(ScriptFunction function, ScriptFile script)
    {
    ...
    private StatementSyntax CreateStatement(ScriptInstruction instruction, ScriptFile script)
    {
    ...
    private PostfixUnaryExpressionSyntax CreatePostfixUnaryExpression(ScriptInstruction instruction, ScriptFile script)
    {
    ...
    private AssignmentStatementSyntax CreateAssignmentStatement(ScriptInstruction instruction, ScriptFile script)
    {
    ...
    private IReadOnlyList<SwitchCaseExpressionSyntax> CreateSwitchCaseExpressions(ScriptInstruction instruction, ScriptFile script)
    {
        if (instruction.ArgumentCount <= 1)
    ...
    private UnaryExpressionSyntax CreateUnaryExpression(ScriptInstruction instruction, ScriptFile script)
    {
        var value = CreateValueExpression(script.Arguments[instruction.ArgumentIndex]);
    ...
    private LogicalExpressionSyntax CreateLogicalExpression(ScriptInstruction instruction, ScriptFile script)
    {
    ...
    private BinaryExpressionSyntax CreateBinaryExpression(ScriptInstruction instruction, ScriptFile script)
    {
        var left = CreateValueExpression(script.Arguments[instruction.ArgumentIndex]);
    ...
    private NameSyntax CreateMethodNameIdentifier(ScriptInstruction instruction, ScriptFile script)
    {
    ...
    private bool IsMethodNameTransfer(ScriptInstruction instruction, ScriptFile script)
    {
