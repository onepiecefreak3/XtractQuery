...
namespace XtractQuery.Compression
{
    public class LZ10
    {
        public static byte[] Decompress(Stream instream, int decompressedSize)
        {
            ...
            return new BinaryReaderY(outstream).ReadBytes(decompressedSize);
        }
        ...
        public static unsafe byte[] Compress(Stream instream)
        {
            ...
            outstream.Position = 0;
            return new BinaryReaderY(outstream).ReadBytes((int)outstream.Length);
        }
