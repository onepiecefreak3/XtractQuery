...
| 111 | Validates a literal value or variable to another variable. Ints and floats stay the same while other types (i.e. string and array) get coeerced to `0`. <br>```$local1 = ~0;```<br>```$local1 = validate_numeric_type($local2);``` |
